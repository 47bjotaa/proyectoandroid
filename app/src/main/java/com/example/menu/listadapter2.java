...
public class listadapter2 extends RecyclerView.Adapter<listadapter2.ViewHolder> {
    private List<ListaDeElementos2> mData;
    private LayoutInflater mInflater;
    private OnFavoritoClickListener onFavoritoClickListener;

    public listadapter2(List<ListaDeElementos2> itemList, Context context, OnFavoritoClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.listadocolegios, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ListaDeElementos2 item = mData.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(ListaDeElementos2 item) {
    ...
    public interface OnFavoritoClickListener {
        void onFavoritoClicked(ListaDeElementos2 item, int position);
    }
}